...
function Sidebar({ isCollapse, setIsCollapse }) {
  ...
  return (
    <>
      <div
        className={` w[80px] h-screen bg-zinc-100 flex flex-col justify-between relative`}
      >
        <div
          className={`${
            isCollapse ? "block" : "hidden"
          } w-10 h-14 p-1 bg-zinc-200 flex items-center justify-center rounded-r-full absolute top-1 left-[-11px] 
        ...
        >
          ...
          <div
            className="w-10 h-14 bg-white flex items-center justify-center rounded-full absolute left-14 bottom-40 "
            onClick={handleSidebarCollapse}
          >
